...
/** \fn signed short gyroReadX(void)
		\brief Funkcja zwracajaca wartosc predkosci obrotowej wokol osi X.
		\brief Prosze zwrocic uwage, ze w domyslnej konfiguracji os X jest wylaczona, aby jej uzyc nalezy odpowiednio zmodyfikowac rejestr zyroskopu CTRL1*/
...
/** \fn signed short gyroReadY(void)
		\brief Funkcja zwracajaca wartosc predkosci obrotowej wokol osi Y.
		\brief Prosze zwrocic uwage, ze w domyslnej konfiguracji os Y jest wylaczona, aby jej uzyc nalezy odpowiednio zmodyfikowac rejestr zyroskopu CTRL1*/
...
/** \fn signed short gyroReadZ(void)
		\brief Funkcja zwracajaca wartosc predkosci obrotowej wokol osi Z.*/
...
/** \fn signed short gyroReadAvg(unsigned int samples, char axis)
...
signed short gyroReadAvg(unsigned int samples, char axis) {
